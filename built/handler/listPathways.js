        ...
        return __generator(this, function (_a) {
            require("../database/getPathway")().then(function (pathways) {
                ...
                pathways.forEach(function (pathway) {
                    ...
                    var fullurl = new url_1.URL('views', process.env.SERVER_URI);
                ...
                var reply = require('../helper/facebookcarousel.js')(x.pathwaynames, x.urls, x.imgurls);
...
//# sourceMappingURL=listPathways.js.map