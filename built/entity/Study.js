...
], Study.prototype, "idstudy", void 0);
__decorate([
    typeorm_1.Column({ type: "enum", enum: degreetype,
...
__decorate([
    typeorm_1.Column({ type: "varchar", width: 45,
        nullable: false, default: null }),
    typeorm_1.ManyToOne(type => Program_1.Program, program => program.name),
...
], Study.prototype, "program", void 0);
Study = __decorate([
    typeorm_1.Entity()
], Study);
exports.Study = Study;
