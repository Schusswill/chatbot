...
module.exports = function(req, res) {
  ...
  switch(action) {
    ...
    case "advisor.findByPathway": require("./handler/advisorByPathway")(body, res);  break;  
    case "flow.course.action":    require("./handler/flowCourse")      (body, res);  break;   
    case "events.upcoming":       require("./handler/eventUpcoming")   (body, res);  break;
    case "events.date":           require("./handler/eventDate")       (body, res);  break; 
